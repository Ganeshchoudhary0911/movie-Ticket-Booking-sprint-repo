...
class MovieServiceTest {
    ...
    // -------- helper builders --------
    private Movie movie(Long id, String name, String genre, String lang, int duration,
    ...
    private MovieDto dto(Long id, String name, String genre, String lang, int duration,
                         String description, double rating, String posterUrl) {
